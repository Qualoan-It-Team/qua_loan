...
String? customerLeadId;
 ...
 void setCustomerLeadId(String id) {
  ...
  Future<void> pickPDF() async {
    ...
    Future<void> bankDocumentsUpload() async {
...
print(" this is first response ${response1.body}");
 ...
 int successfulUploads = 0;
    ...
    for (var file in selectedFiles) {
      ...
      final requestBody = jsonEncode({
       ...
       print("${bankPasswordController.text.trim()}");
      //send the request
  ...
  update();
      if (response2.statusCode == 200) {
        ...
        Get.snackbar(
          backgroundColor: AppColors.logoRedColor,
          colorText: Colors.white,
          'Error', 'Failed to upload Bank statement : ${file.path}');
      }
    }
    isLoading = false;
  update();
